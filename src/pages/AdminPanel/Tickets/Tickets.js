          ...
          <tbody>
            {tickets.map((ticket, index) => (
              <tr key={ticket._id}>
                ...
                <td>
                  <button type="button" class="btn btn-primary edit-btn" onClick={()=> showtickets(ticket.body)}>
                    مشاهده
                  </button>
                </td>
                <td>
                  <button type="button" class="btn btn-primary edit-btn" onClick={() => setAnswerToTicket(ticket._id)}>
                    پاسخ
                  </button>
                </td>
              </tr>
